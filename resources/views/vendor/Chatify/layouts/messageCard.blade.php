...
@if($viewType == 'default')
    ...
    <div class="message-card" data-id="{{ $id }}">
        <p style="border-radius: 7px;">{!! ($message == null && $attachment != null && @$attachment[2] != 'file') ? $attachment[1] : nl2br($message) !!}
    ...
    <div>
        <div class="message-card">
            <div class="image-file chat-image" style="width: 250px; height: 150px;background-image: url('{{ secure_asset('storage/'.config('chatify.attachments.folder').'/'.$attachment[0]) }}')">
            </div>
        </div>
    </div>
    @endif
...
@if($viewType == 'sender')
    <div class="message-card mc-sender" data-id="{{ $id }}">
        <p style="background: #e03;border-radius: 7px;">{!! ($message == null && $attachment != null && @$attachment[2] != 'file') ? $attachment[1] : nl2br($message) !!}
