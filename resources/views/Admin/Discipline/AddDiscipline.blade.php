              ...
              <div class="col-12 col-xl-12 mb-4 mb-xl-0 p-0">
                <div>
                  <div class="bg-white p-2">
                   <h5 class="card-title mb-4 font-weight-bold ml-2 mt-2 tx">Kỷ luật</h5>

                   <form id="form-add-department" method="post" action="{{url('admin/discipline/add')}}">
                    @csrf
                    <div class="row m-0">
                      ...
                      <div class="col-12 p-0 pr-2 mb-2 text-center mt-3">
                        <button class="btn bg text-white">Tạo kỷ luật</button>
                      </div>
                    </div>
                  </form>
                </div>
