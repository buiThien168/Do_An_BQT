                         ...
                         <div class="float-right"> 
                          <form method="get">    
                            <div class="form-group mb-3" style="display: flex"> 
                              <a href="{{url('admin/discipline/add')}}">
                                <div class="btn btn-success mr-2" style="width: 140px;">Tạo kỷ luật</div>      
                              </a> 
                        ...
                        <div class="table-responsive">
                          <table class="table table-hover table-striped">
                            ...
                            <tbody>
                             ...
                             <td>
                              <a href="{{url('admin/discipline/edit')."/".$item->id}}">
                            ...
                            <div class="modal-dialog" role="document">
                              <div class="modal-content">
                               ...
                               <div class="p-2">
                                 ...
                                 <a  href="{{url('admin/discipline/delete')."/".$item->id}}">
