      ...
      <div class="content-wrapper p-3">
        <div class="row">
                        ...
                        <div class="table-responsive">
                          <table class="table table-hover table-striped">
                            ...
                            <tbody>
                             ...
                             <td>
                              <a href="{{url('admin/position-management/see-employee')."/".$item->id}}">
                                <button class="btn bg mr-2 text-white">Xem người dùng</button>
                              </a>
                              <a href="{{url('admin/position-management/edit')."/".$item->id}}">
                            ...
                            <div class="modal-dialog" role="document">
                              <div class="modal-content">
                               ...
                               <div class="p-2">
                                 ...
                                 <a  href="{{url('admin/position-management/delete')."/".$item->id}}">
          ...
          <div class="float-right pr-3">
           {{ $GetPositions->links('pagination::bootstrap-4') }}
         </div>
         <div style="clear: both"></div>
       </div>
     </div>
