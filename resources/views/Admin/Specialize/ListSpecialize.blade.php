      ...
      <div class="content-wrapper">
        <div class="row">
                         ...
                         <div class="float-right"> 
                          <form method="get">    
                            <div class="form-group mb-3" style="display: flex"> 
                              <a href="{{url('admin/professional-management/add')}}">
                        ...
                        <div class="table-responsive">
                          <table class="table table-hover table-striped">
                            ...
                            <tbody>
                             ...
                             @foreach($GetSpecializes as $item)
                             <tr>
                              <td>{{$idup++}}</td>
                             ...
                             <td>
                              <a href="{{url('admin/professional-management/see-employee')."/".$item->id}}">
                                <button class="btn bg mr-2 text-white">Xem người dùng</button>
                              </a>
                              <a href="{{url('admin/professional-management/edit')."/".$item->id}}">
                            ...
                            <div class="modal-dialog" role="document">
                              <div class="modal-content">
                                <div class="modal-header">
                                  <h5 class="modal-title" id="exampleModalLabel">Xóa chuyên ngành</h5>
                               ...
                               <div class="p-2">
                                 ...
                                 <a  href="{{url('admin/professional-management/delete')."/".$item->id}}">
          ...
          <div class="float-right pr-3">
           {{ $GetSpecializes->links('pagination::bootstrap-4') }}
         </div>
         <div style="clear: both"></div>
       </div>
     </div>
