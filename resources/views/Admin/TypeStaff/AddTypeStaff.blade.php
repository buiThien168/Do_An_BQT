              ...
              <div class="col-12 col-xl-12 mb-4 mb-xl-0 p-0">
                <div>
                  <div class="bg-white p-2">
                   <h5 class="card-title mb-4 font-weight-bold ml-2 mt-2 tx">Thêm loại nhân viên</h5>
                   <form  method="post" action="{{url('admin/manage-employee-type/add')}}">
                    @csrf
                    <div class="row m-0">
                      ...
                      <div class="col-12 p-0 pr-2 mb-2 text-center mt-3">
                        <button class="btn bg text-white">Thêm loại nhân viên</button>
                      </div>
                    </div>
                  </form>
                </div>
