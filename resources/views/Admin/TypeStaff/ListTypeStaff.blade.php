      ...
      <div class="content-wrapper p-3">
        <div class="row">
                    ...
                    <div class="col-lg-12 grid-margin stretch-card">
                      <div class="card">
                        <div class="card-body px-0">
                         <h5 class="card-title float-left mb-2 tx">Danh sách loại nhân viên</h5>
                         <div class="float-right"> 
                          <form method="get">    
                            <div class="form-group mb-3" style="display: flex"> 
                              <a href="{{url('admin/manage-employee-type/add')}}">
                                <div class="btn btn-success mr-2" style="width: 140px;">Thêm loại nhân viên</div>      
                              </a>                
                        ...
                        <div class="table-responsive">
                          <table class="table table-hover table-striped">
                            <thead>
                              <th width="3%">#</th>
                              <th width="4%">Mã số</th>
                              <th width="15%">Tên Loại nhân viên</th>
                            ...
                            <tbody>
                             ...
                             <tr>
                              ...
                              <td>
                                ...
                                @if($item->id == $count->employee_type)
                                @php
                                $countSteff++;
                                @endphp
                                @endif
                             ...
                             <td>
                              <a href="{{url('admin/manage-employee-type/see-employee')."/".$item->id}}">
                                <button class="btn bg mr-2 text-white">Xem người dùng</button>
                              </a>
                              <a href="{{url('admin/manage-employee-type/edit')."/".$item->id}}">
                            ...
                            <div class="modal-dialog" role="document">
                              <div class="modal-content">
                                ...
                                <div class="modal-body">
                                 <p>Bạn đồng ý Xóa loại nhân viên {{$item->name}}?</p>
                               </div>
                               <div class="p-2">
                                 <button type="button" class="btn btn-secondary float-right" data-dismiss="modal">Hủy bỏ</button>
                                 <a  href="{{url('admin/manage-employee-type/delete')."/".$item->id}}">
          ...
          <div class="float-right pr-3">
           {{ $GetTypeStaffs->links('pagination::bootstrap-4') }}
         </div>
         <div style="clear: both"></div>
       </div>
     </div>
